...
public class ProjectileData {
    ...
    public static final Map<ResourceLocation, ProjectileInfo> projectileInfoMap = new HashMap<>();
    public static final List<ResourceLocation> blacklistedProjectiles = new ArrayList<>();

    /*
     * Registers a projectile with the given ID and info.
     * @param id The unique ResourceLocation for the projectile (e.g., "minecraft:arrow").
     * @param info The ProjectileInfo containing physics parameters and update order.
     * @since 1.0.30
     */
    public static void registerProjectile(ResourceLocation id, ProjectileInfo info) {
        projectileInfoMap.put(id, info);
    }

    /*
     * Adds a projectile ID to the blacklisted list, it will prevent it from showing a trajectory.
     * @param id The unique ResourceLocation for the projectile.
     * @since 1.0.30
     */
     ...
     */
    @ApiStatus.Internal
    public static ProjectileInfo getProjectileInfo(ResourceLocation id) {
     ...
     */
    @ApiStatus.Internal
    public static boolean hasProjectileInfo(ResourceLocation id) {
