...
public class ProjectileInfo {
    ...
    static public List<ProjectileInfo> getItemsInfo(ItemStack itemStack, Player player, boolean isMainHand) {
        ...
        float tickProgress = Minecraft.getInstance().getTimer().getGameTimeDeltaPartialTick(false);
        ...
        if (item instanceof BowItem && SettingsManager.TOGGLE_BOW.getValue()) {
            ...
            Vec3 vel = player.getViewVector(tickProgress).scale(TridentItem.SHOOT_POWER);
            ...
            Vec3 vel = player.getViewVector(tickProgress).scale(1.5);
            Vec3 offset = new Vec3(0.2, -0.06, 0.2);
